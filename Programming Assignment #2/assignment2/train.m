...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    Train_CE(train_counter) = this_chunk_CE;
...
model.vocab = vocab;
model.Train_CE = Train_CE;
model.val_CE = val_CE;
model.test_CE = test_CE;
